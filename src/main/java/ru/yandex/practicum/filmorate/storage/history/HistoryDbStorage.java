...
public class HistoryDbStorage extends BaseDbStorage<Event> {
    ...
    public Event addEvent(Event event) {
        ...
        log.info("Создан новый ЭВЕНТ с ID {}. Добавлено действие {} {} = {} пользователя с ID = {}.",
                event.getEventId(), event.getEventType().toString(), event.getOperation().toString(),
    ...
    public void saveHistoryEvent(Integer userId, long timestamp,
                                 EventType eventType, OperationType operationType, Integer entityId) {
